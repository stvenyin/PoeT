...
pub mod pallet{
    use frame_support::{dispatch::DispatchResultWithPostIno,pallet_prelude::*}
    use frame_system::pallet_prelude::*;
    use sp_std::vec::Vec;

    #[pallet::config]

    pub trait Congig: frame_system::Congig{
        type Event:From<Event<Self> + IsType<<Self as frame_system::Congig>::Event>;
    }
...
pub type Proofs<T: Congig> = StorageMap<
    _,
    blake2_128_concat,
    Vec<u8>,
